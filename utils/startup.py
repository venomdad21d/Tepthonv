    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙴𝙽𝙾𝙼", "https://t.me/Ve_No_m_S"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_file("@BotFather", "Tepthon/zilzal/LogoVenom.jpg")
...
Tepthon = {"@Ve_No_m_S", "@Ve_No_m_S", "@Ve_No_m_S", "@S_Ml10", "@VNOM_SuPpOrt"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="Venom/malath/Venom.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل فينوم", zedub, Config.TG_BOT_USERNAME, descript, photozed

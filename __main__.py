...
import sys, asyncio
import Venom
from Venom import zedub
from Venom import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
print(Venom.__copyright__)
print(f"المرخصة بموجب شروط  {Venom.__license__}")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Venom","PPYNY","Venom1","Tws_Venom","Venom_Help","super_Venom","Venomklaesh","x_wwl","K_K_Q_L","VisaVenom","zszxzz","TIKTOK_ased","huueuu","PyThOnX1"]
    ...
    print(f"⌔┊تـم تنصيـب حسابك بنجاح ع سورس فينوم . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()

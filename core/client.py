                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @S_Ml10\
                                  \n\n--------بـدء تتبـع سجـل فينوم 𝚅𝙴𝙽𝙾𝙼--------\
                        ...
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/S_Ml10)"
                        text = (
                            "**✘ تقـريـر إشعـار فينوم 𝚅𝙴𝙽𝙾𝙼 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار فينوم 𝚅𝙴𝙽𝙾𝙼 ✘**\n\n "
                        link = "[𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿(https://t.me/S_Ml10)"

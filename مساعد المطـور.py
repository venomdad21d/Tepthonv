...
ZelzalDV_cmd = (
    "𓆩 [𝚂𝙾𝚄𝚁𝙲𝙴 𝚅𝙴𝙽𝙾𝙼 - اوامــر المطـور المســاعد](t.me/Ve_No_m_S) 𓆪\n\n"
    ...
    "\n𓆩 [ 𝚃𝙰𝚈𝚂𝙾𝙽 - مطـور السـورس](t.me/S_Ml10) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت فينوم 𝚅𝙴𝙽𝙾𝙼 انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝚅𝙴𝙽𝙾𝙼 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت فينوم 𝚅𝙴𝙽𝙾𝙼 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
